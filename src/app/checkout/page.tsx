          ...
          <div className="mb-8">
            {data.validCouponId ? (
              ...
              <form onSubmit={applyCoupon} className="flex gap-2">
                ...
                />
                <button type="submit" disabled={!couponCode || loading} className="bg-zinc-700/50 hover:bg-gray-300 text-zinc-100 px-4 rounded-xl font-medium transition-colors disabled:opacity-50">
                  Apply
                </button>
              </form>
            )}
