  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-zinc-100 leading-tight">All Properties</h1>
          <p className="text-zinc-400 text-sm">Manage and browse all properties</p>
        </div>
        <div className="flex items-center gap-3">
          <button 
            onClick={() => setIsAmenitiesModalOpen(true)}
            className="flex items-center justify-center gap-2 px-4 py-2.5 bg-zinc-900/40 backdrop-blur-xl border border-zinc-700/50 text-zinc-300 hover:bg-zinc-950/50 rounded-xl text-sm font-medium transition-colors shadow-sm"
          >
      ...
      <div className="bg-zinc-900/40 backdrop-blur-xl p-4 rounded-2xl border border-zinc-800/60 shadow-sm space-y-4">
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button className="flex items-center justify-center gap-2 px-6 py-2.5 bg-zinc-900/40 backdrop-blur-xl border border-zinc-700/50 text-zinc-300 hover:bg-zinc-950/50 rounded-xl text-sm font-medium transition-colors sm:w-auto w-full">
            <Filter className="w-4 h-4" /> Filters
          </button>
        </div>
        
        <div>
          <div className="text-xs font-semibold text-zinc-400 mb-2 uppercase">Filter by Project</div>
      ...
      {/* Overview Stats */}
      <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl border border-zinc-800/60 shadow-sm p-4 flex flex-wrap gap-x-12 gap-y-4">
        <div className="flex items-center gap-3">
        ...
        <div>
          <div className="text-xs font-medium text-zinc-400 mb-0.5">Projects</div>
          <div className="font-bold text-zinc-100">3</div>
        </div>
        <div>
          <div className="text-xs font-medium text-zinc-400 mb-0.5">Properties</div>
          <div className="font-bold text-zinc-100">2</div>
        </div>
        <div>
          <div className="text-xs font-medium text-zinc-400 mb-0.5">Filtered</div>
          <div className="font-bold text-zinc-100">2</div>
        </div>
        <div>
          <div className="text-xs font-medium text-zinc-400 mb-0.5">Selected Project</div>
          <div className="font-bold text-zinc-100">All</div>
        </div>
      </div>
        ...
        {properties.map((prop) => (
          <div key={prop.id} className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl border border-zinc-800/60 shadow-sm overflow-hidden flex flex-col hover:shadow-md transition-shadow">
            ...
            <div className="p-5 flex-1 flex flex-col">
              <h3 className="font-bold text-lg text-zinc-100 mb-1">{prop.title}</h3>
              ...
              {(prop.area || prop.units) && (
                <div className="flex items-center gap-6 bg-blue-50/50 rounded-xl p-3 mb-4">
                  <div>
                    <div className="text-xs font-medium text-zinc-400">Total Area</div>
                    <div className="font-bold text-zinc-100 text-sm">{prop.area}</div>
                  </div>
                  <div>
                    <div className="text-xs font-medium text-zinc-400">Units</div>
                    <div className="font-bold text-zinc-100 text-sm">{prop.units}</div>
                  </div>
                </div>
              )}
              ...
              <div className="mt-auto pt-4">
                ...
                <div className="flex gap-2 mb-4">
                  <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 border border-zinc-700/50 rounded-xl text-sm font-semibold text-zinc-300 hover:bg-zinc-950/50 transition-colors">
                  ...
                  <button className="flex items-center justify-center px-4 py-2 border border-zinc-700/50 text-zinc-400 rounded-xl hover:bg-zinc-950/50 transition-colors">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 flex-1 overflow-y-auto space-y-8">
              ...
              <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-700/50 rounded-xl p-5 shadow-sm">
                <h3 className="font-semibold text-zinc-100 mb-4">Add New Amenity</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label className="block text-sm font-medium text-zinc-300 mb-1.5">Amenity Name *</label>
                    <input 
                      type="text" 
                      placeholder="e.g., Swimming Pool" 
                      className="w-full px-4 py-2.5 rounded-lg border border-zinc-700/50 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-zinc-300 mb-1.5">Font Awesome Icon Class *</label>
                    <input 
                      type="text" 
              ...
              <div>
                <h3 className="font-semibold text-zinc-100 mb-4 text-lg">All Amenities (0)</h3>
                
                <div className="py-12 flex flex-col items-center justify-center text-center">
                  <div className="w-16 h-16 bg-zinc-950/50 rounded-full flex items-center justify-center mb-4">
                    <Settings2 className="w-8 h-8 text-slate-300" />
                  </div>
                  <p className="text-zinc-400">No amenities added yet. Add your first amenity above.</p>
                </div>
              </div>

            </div>

            <div className="p-6 border-t border-zinc-800/60 bg-zinc-950/50/50">
              <button 
                onClick={() => setIsAmenitiesModalOpen(false)}
                className="w-full py-2.5 bg-zinc-900/40 backdrop-blur-xl border border-zinc-700/50 hover:bg-zinc-950/50 text-zinc-300 rounded-xl text-sm font-bold transition-colors shadow-sm"
              >
                Close
              </button>
            </div>
