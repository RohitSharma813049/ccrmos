  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-zinc-100 leading-tight">Merge Duplicate Leads</h1>
          <p className="text-zinc-400 text-sm">Same Mobile Number + Same Assignee</p>
        </div>
      ...
      <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl border border-zinc-800/60 shadow-sm overflow-hidden">
        <div className="p-4 border-b border-zinc-800/60 bg-zinc-950/50/50 flex items-center gap-2">
          <User className="w-5 h-5 text-purple-600" />
          <h2 className="font-bold text-zinc-100">Duplicates by Sales Person</h2>
        </div>
        
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="text-[11px] text-zinc-400 font-bold uppercase tracking-wider border-b border-zinc-800/60">
              <tr>
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-zinc-950/50/50 transition-colors">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-zinc-100">Shivani Saini</div>
                      <div className="text-xs text-zinc-400">shivanisaini110@gmail.com</div>
                    </div>
                  </div>
                </td>
      ...
      <div className="flex flex-col lg:flex-row gap-6 h-[600px]">
        ...
        <div className="w-full lg:w-[400px] shrink-0 bg-zinc-900/40 backdrop-blur-xl rounded-2xl border border-zinc-800/60 shadow-sm flex flex-col overflow-hidden">
          <div className="p-4 border-b border-orange-100 bg-orange-50/50 flex items-center gap-2">
            <Users className="w-5 h-5 text-orange-600" />
            <h2 className="font-bold text-zinc-100">Duplicate Groups (26)</h2>
          </div>
          
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-zinc-950/50/30">
            
            {/* Card 1 */}
            <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-700/50 rounded-xl shadow-sm hover:border-blue-300 hover:shadow-md transition-all cursor-pointer">
