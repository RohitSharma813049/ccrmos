...
export default function LeadsPage() {
  return (
    <div className="max-w-[1400px] mx-auto space-y-6">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-zinc-100 leading-tight">All Leads</h1>
        <p className="text-zinc-400 text-sm">Manage and track all your leads</p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button className="flex items-center gap-2 px-4 py-3 bg-zinc-900/40 backdrop-blur-xl border border-zinc-700/50 text-zinc-300 hover:bg-zinc-950/50 rounded-xl text-sm font-medium transition-colors shadow-sm">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-xl p-4 border border-zinc-800/60 shadow-sm flex flex-col justify-center">
          <p className="text-xs font-medium text-zinc-400 mb-1">Total Leads</p>
          <h3 className="text-xl font-bold text-blue-600">3330</h3>
        </div>
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-xl p-4 border border-zinc-800/60 shadow-sm flex flex-col justify-center">
          <p className="text-xs font-medium text-zinc-400 mb-1">Hot Leads</p>
          <h3 className="text-xl font-bold text-red-500">115</h3>
        </div>
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-xl p-4 border border-zinc-800/60 shadow-sm flex flex-col justify-center">
          <p className="text-xs font-medium text-zinc-400 mb-1">Warm Leads</p>
          <h3 className="text-xl font-bold text-orange-500">443</h3>
        </div>
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-xl p-4 border border-zinc-800/60 shadow-sm flex flex-col justify-center">
          <p className="text-xs font-medium text-zinc-400 mb-1">Cold Leads</p>
          <h3 className="text-xl font-bold text-blue-500">43</h3>
        </div>
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-xl p-4 border border-zinc-800/60 shadow-sm flex flex-col justify-center">
          <p className="text-xs font-medium text-zinc-400 mb-1">Fresh Leads</p>
          <h3 className="text-xl font-bold text-green-500">2764</h3>
        </div>
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-xl p-4 border border-zinc-800/60 shadow-sm flex flex-col justify-center">
          <p className="text-xs font-medium text-zinc-400 mb-1">Follow-ups</p>
          <h3 className="text-xl font-bold text-blue-600">163</h3>
        </div>
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-xl p-4 border border-zinc-800/60 shadow-sm flex flex-col justify-center">
          <p className="text-xs font-medium text-zinc-400 mb-1">Not Assigned</p>
          <h3 className="text-xl font-bold text-red-500">10</h3>
        </div>
      </div>

      {/* Main Content Area */}
      <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl border border-zinc-700/50 shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-b border-zinc-800/60">
          <div className="relative max-w-2xl">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-3 rounded-xl border border-zinc-700/50 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm"
            />
          </div>
        </div>

        {/* Filter Accordions */}
        <div className="p-4 border-b border-zinc-800/60 space-y-3 bg-zinc-950/50/50">
          <div className="bg-green-50/50 border border-green-100 rounded-xl p-3 flex items-center justify-between cursor-pointer hover:bg-green-50 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-semibold text-zinc-100 text-sm">Table Columns</h4>
                <p className="text-xs text-zinc-400">13 of 13 columns selected</p>
              </div>
            </div>
          ...
          <div className="bg-blue-50/50 border border-blue-100 rounded-xl p-3 flex items-center justify-between cursor-pointer hover:bg-blue-50 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-semibold text-zinc-100 text-sm">All Filters</h4>
                <p className="text-xs text-zinc-400">3330 Total Leads</p>
              </div>
            </div>
        ...
        <div className="overflow-x-auto min-h-[500px]">
          <table className="w-full text-sm text-left whitespace-nowrap">
            <thead className="text-xs text-zinc-400 font-semibold bg-zinc-900/40 backdrop-blur-xl border-b border-zinc-700/50">
              <tr>
                <th className="px-4 py-4 w-10"><input type="checkbox" className="rounded border-zinc-700/50" /></th>
            ...
            <tbody className="divide-y divide-slate-100 bg-zinc-900/40 backdrop-blur-xl">
              {leads.map((lead, i) => (
