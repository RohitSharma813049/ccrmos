  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-zinc-100 leading-tight">Bookings Management</h1>
          <p className="text-zinc-400 text-sm">Manage all property bookings and client information</p>
        </div>
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-4 py-2.5 bg-zinc-900/40 backdrop-blur-xl border border-zinc-700/50 text-zinc-300 hover:bg-zinc-950/50 rounded-xl text-sm font-medium transition-colors shadow-sm">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl p-5 border border-zinc-800/60 shadow-sm flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-zinc-100">1</h3>
          </div>
        ...
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl p-5 border border-zinc-800/60 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-zinc-400 mb-1">Confirmed</p>
        ...
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl p-5 border border-zinc-800/60 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-zinc-400 mb-1">Pending</p>
        ...
        <div className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl p-5 border border-zinc-800/60 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-zinc-400 mb-1">Total Value</p>
      ...
      <div className="bg-zinc-900/40 backdrop-blur-xl p-4 rounded-2xl border border-zinc-800/60 shadow-sm flex flex-col md:flex-row gap-4">
        ...
        <button className="flex items-center justify-center gap-2 px-6 py-2.5 bg-zinc-900/40 backdrop-blur-xl border border-zinc-700/50 text-zinc-300 hover:bg-zinc-950/50 rounded-xl text-sm font-medium transition-colors shrink-0">
      ...
      <div className="space-y-4">
        {bookings.map((booking, i) => (
          <div key={i} className="bg-zinc-900/40 backdrop-blur-xl rounded-2xl border border-zinc-800/60 shadow-sm p-6 hover:shadow-md transition-shadow">
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
              ...
              <div className="flex items-start gap-4 shrink-0">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    <h3 className="font-bold text-lg text-zinc-100">{booking.name} <span className="text-slate-400 text-sm font-normal">({booking.id})</span></h3>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-8 gap-y-4 mt-6">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-zinc-300 text-sm">{booking.email}</div>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="font-bold text-zinc-100 text-sm">{booking.total}</div>
                    </div>
                    <div>
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="font-medium text-zinc-300 text-sm">{booking.date}</div>
                    </div>
                  </div>
              ...
              {/* Right: Actions */}
              <div className="flex items-center gap-2 shrink-0 border-t md:border-t-0 md:border-l border-zinc-800/60 pt-4 md:pt-0 md:pl-6">
                <button className="flex items-center gap-1.5 px-3 py-1.5 text-zinc-400 hover:text-zinc-100 border border-zinc-700/50 rounded-lg text-sm font-medium transition-colors shadow-sm">
